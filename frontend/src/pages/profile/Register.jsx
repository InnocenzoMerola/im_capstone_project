      ...
      {loading ? (
        <div className="spinner-reg">
          <div className="text-center">
            <h2 className="mb-3">Caricamento in corso...</h2>
            ...
            <div className="row justify-content-center shadow-div">
              ...
              <div className="col-12 col-md-5 side-register">
                ...
                <p className="text-center">
                  Ti diamo il benvenuto nella meravigliosa Napoli, dove ogni strada e piazza sono testimoni di una
                  storia millenaria e di una cultura vibrante. Unisciti a noi nel viaggio alla scoperta dei luoghi più
                  affascinanti e nascosti di questa città, pronti a raccontarti le loro storie e a incantarti con la
